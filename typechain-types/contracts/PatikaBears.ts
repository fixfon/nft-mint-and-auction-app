...
export interface PatikaBearsInterface extends utils.Interface {
  functions: {
    ...
    "publicSafeMint()": FunctionFragment;
    ...
    "toggleIsPublicMintEnabled()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "publicSafeMint",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "toggleIsPublicMintEnabled",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface PatikaBears extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PatikaBearsInterface;
  ...
  callStatic: {
    ...
    publicSafeMint(overrides?: CallOverrides): Promise<void>;
    ...
    toggleIsPublicMintEnabled(overrides?: CallOverrides): Promise<void>;
