...
export type { Auction } from "./contracts/Auction.sol/Auction";
export { Auction__factory } from "./factories/contracts/Auction.sol/Auction__factory";
export type { PatikaBears } from "./contracts/PatikaBears";
export { PatikaBears__factory } from "./factories/contracts/PatikaBears__factory";
